    ...
    public static class MinimalInfoPanel
    {
        ...
        public static void BuildMenu(GameObject canvas)
        {
            ...
            */
            ...
            altPanel.AddText("Alt pos Label", "Pos", new Vector2(80f, 10f), Vector2.zero, GUIController.Instance.arial);
 
            altPanel.AddText("Alt MP Label", "MP", new Vector2(10f, 30f), Vector2.zero, GUIController.Instance.arial, 15);
            altPanel.AddText("Alt Nail Damage Label", "NailDmg", new Vector2(70f, 30f), Vector2.zero, GUIController.Instance.arial, 15);
            altPanel.AddText("Alt canSuperdash Label", "CanCdash", new Vector2(130f, 30f), Vector2.zero, GUIController.Instance.arial, 15);

            altPanel.AddText("Alt Completion Label", "Completion", new Vector2(10f, 50f), Vector2.zero, GUIController.Instance.arial, 15);
            altPanel.AddText("Alt Grubs Label", "Grubs", new Vector2(90f, 50f), Vector2.zero, GUIController.Instance.arial, 15);
         
            altPanel.AddText("Alt Scene Name Label", "Scene Name", new Vector2(10f, 70f), Vector2.zero, GUIController.Instance.arial, 15);
            altPanel.AddText("Alt Current Save State Lable", "Current SaveState", new Vector2(10f, 90f), Vector2.zero, GUIController.Instance.arial, 15);
            altPanel.AddText("Alt SaveState AutoSlot", "Autoslot", new Vector2(10f, 110f), Vector2.zero, GUIController.Instance.arial, 15);
            altPanel.AddText("Alt SaveState CurrentSlot", "Current slot", new Vector2(70f, 110f), Vector2.zero, GUIController.Instance.arial, 15);
            ...
            //Values
            altPanel.AddText("Vel", "", new Vector2(40f, 10f), Vector2.zero, GUIController.Instance.trajanNormal);
            altPanel.AddText("Pos", "", new Vector2(120f, 10f), Vector2.zero, GUIController.Instance.trajanNormal);
 
            altPanel.AddText("MP", "", new Vector2(50f, 30f), Vector2.zero, GUIController.Instance.trajanNormal);
            altPanel.AddText("NailDmg", "", new Vector2(100f, 30f), Vector2.zero, GUIController.Instance.trajanNormal);
            altPanel.AddText("CanCdash", "", new Vector2(160f, 30f), Vector2.zero, GUIController.Instance.trajanNormal);

            altPanel.AddText("Completion", "", new Vector2(60f, 50f), Vector2.zero, GUIController.Instance.trajanNormal);
            altPanel.AddText("Grubs", "", new Vector2(120f, 50f), Vector2.zero, GUIController.Instance.trajanNormal);

            altPanel.AddText("Scene Name", "", new Vector2(50f, 70f), Vector2.zero, GUIController.Instance.trajanNormal);
            altPanel.AddText("Current SaveState", "", new Vector2(50f, 90f), Vector2.zero, GUIController.Instance.trajanNormal);
            altPanel.AddText("Autoslot", "", new Vector2(40f, 110f), Vector2.zero, GUIController.Instance.trajanNormal);
            altPanel.AddText("Current slot", "", new Vector2(120f, 110f), Vector2.zero, GUIController.Instance.trajanNormal);
        ...
        public static void Update()
        {
            ...
            if (altPanel.active)
            {
                ...
                altPanel.GetText("Autoslot").UpdateText(string.Format("Auto-select: {0}",
                            GetStringForBool(SaveStateManager.GetAutoSlot())));
                altPanel.GetText("Current slot").UpdateText(string.Format("Current slot: {0}", slotSet));
                /*
